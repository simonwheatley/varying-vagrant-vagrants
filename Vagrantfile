...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :apache do |apache|
	  ...
	  apache.vm.network :private_network, ip: "192.168.50.5"
	 
	  # Drive mapping
	  #
	  # The following apache.vm.share_folder settings will map directories in your Vagrant
	  ...
	  apache.vm.synced_folder "provision/flags/", "/home/vagrant/flags/"
	  # 
